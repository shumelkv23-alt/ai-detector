...
Тема: определение того, сгенерировано ли изображение нейросетью, с помощью
ансамбля предобученных классификаторов и судебно-криминалистического (forensic) анализа.
